module.exports = function (credentials) {
	...
	var deleteKey = require('key-del');
		...
		module.removeSubscription =  function(hashtag){
		  ...
		  needle.delete('https://api.instagram.com/v1/subscriptions?&client_id=' + serverCredentials.clientId + '&id=' + id + '&client_secret=' + serverCredentials.clientSecret, post_data, options,
		  	(function(scope){
