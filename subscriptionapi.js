...
var self = {
	...
	removeAllSubscriptions: function(credentials){
		...
		for(var currentsub in subscribedTags){
			needle.delete('https://api.instagram.com/v1/subscriptions?&client_id=' + credentials.clientId + '&object=' + 'tag' + '&client_secret=' + credentials.clientSecret, post_data, options, self.removeSubscription_success);
		}
	},
	removeSubscription_success : function(){
